...
export default function Home({ onNavigate, userData }: HomeProps) {
  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-[#e0f2f1] to-[#f4fbf9] pb-8">
      {/* Top Section */}
      <div className="bg-[#004d40] rounded-b-[2.5rem] p-6 pt-12 text-white shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-800 font-bold text-xl border-2 border-white">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 mb-6">
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-xs bg-emerald-600/50 px-2 py-0.5 rounded-full">{accountNumber}</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              ...
              className="bg-white text-[#004d40] py-3 px-4 rounded-xl font-semibold flex items-center justify-center space-x-2 shadow-md active:scale-95 transition-transform"
            >
            ...
            <button 
              ...
              className="bg-emerald-600/50 text-white py-3 px-4 rounded-xl font-semibold flex items-center justify-center space-x-2 border border-emerald-500/50 active:scale-95 transition-transform"
            >
      ...
      <div className="px-4 mt-6 space-y-6">
        ...
        <div>
          <div className="flex justify-between items-center mb-3 px-1">
            ...
            <button 
              ...
              className="text-emerald-700 text-sm font-medium flex items-center"
            >
              ...
              {utilities.map((item, index) => (
                ...
                >
                  <div className="relative mb-2">
                    <div className="w-14 h-14 bg-emerald-50 rounded-2xl flex items-center justify-center text-emerald-800 group-active:scale-95 transition-transform">
        ...
        <div>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-emerald-50 overflow-hidden relative">
            <div className="bg-[#e8f5e9] p-5 pb-6">
              <div className="pr-20">
                <p className="text-gray-800 font-medium mb-4 leading-snug">
                  Bạn đang gặp vấn đề gì cần hỗ trợ? Chat với tôi ngay nhé!
                </p>
                <div className="flex space-x-3">
                  <button 
                    onClick={() => onNavigate('placeholder', 'Chat hỗ trợ')}
                    className="flex-1 bg-white text-emerald-800 py-2.5 px-4 rounded-full font-semibold flex items-center justify-center space-x-2 shadow-sm border border-emerald-100 active:scale-95 transition-transform"
                  >
                  ...
                  <button 
                    ...
                    className="w-11 h-11 bg-[#004d40] text-white rounded-full flex items-center justify-center shadow-sm shrink-0 active:scale-95 transition-transform"
                  >
                    <Smartphone className="w-5 h-5" />
                  </button>
                </div>
              </div>
              <div className="absolute top-2 right-2 w-24 h-24 bg-emerald-200 rounded-full flex items-center justify-center border-4 border-white shadow-md">
                <div className="text-emerald-700 text-center leading-tight font-bold">
